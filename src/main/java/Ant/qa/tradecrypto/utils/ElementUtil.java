...
public class ElementUtil {
	...
	public void doSendKeysSelfie(By locator, String value) {
		if (value == null) {
			System.out.println("null vlaues are not allowed");
			//throw new MySeleniumException("VALUECANNOTBENULL");
		}
	...
	public String pasteData () throws IOException, UnsupportedFlavorException {
...
//	public void getGAuth(String authKey)
//	{
//		Totp totp = new Totp(authKey);
